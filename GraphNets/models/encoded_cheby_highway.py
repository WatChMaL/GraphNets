...
class Net(torch.nn.Module):
    def __init__(self, k=3, layers=7, graph_w=128, concat_layers=[3,5,7], lin_ws=[32,8]):
        ...
        # Encoding
        self.pre_lin1 = Linear(38, 64)
        self.pre_bn1 = BatchNorm1d(64)
        self.pre_lin2 = Linear(64,32)
        self.pre_bn2 = BatchNorm1d(32)
        self.pre_lin3 = Linear(32, 16)
        self.pre_bn3 = BatchNorm1d(16)
        self.pre_lin4 = Linear(16,8)
        self.pre_bn4 = BatchNorm1d(8)
    ...
    def forward(self, batch):
        ...
        x = self.pre_bn1(F.elu(self.pre_lin1(x)))
        x = self.pre_bn2(F.elu(self.pre_lin2(x)))
        x = self.pre_bn3(F.elu(self.pre_lin3(x)))
        x = self.pre_bn4(F.elu(self.pre_lin4(x)))
