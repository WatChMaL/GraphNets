#!/bin/bash
#SBATCH --job-name=train_graphnet
...
singularity exec --nv -B $SLURM_TMPDIR:/fast_scratch -B $PROJECT_DIR:/project_dir $SINGULARITY_IMAGE python /project_dir/GraphNets/cedar_main.py
